...
export class MessagerieServiceService {
  ...
  geMsgs(){
   ...
   geMsgsIdUserIdReciver(idSend : number ,idRec : number){
    return this.http.get("http://localhost:8080/api/message/show/"+idSend+"/"+idRec) ; 
 
   }
   addMsg(msg:any){
    return this.http.post("http://localhost:8080/api/message",msg) ;
